    ...
    <b-row class="mx-0">
      <b-col cols="12" md="9" class="mx-auto">
        <b-card class="pay-online__card mt-4">
          <h1 class="pay-online__title2-card text-center">Puedes realizar tus pagos por medio de las plataformas digitales</h1>
          <b-row class="mx-0 justify-content-around mt-4">
            <b-col cols="12" md="4" class="mb-3 mb-md-1">
              <h2 class="pay-online__subtitle-card text-center">YAPE, TUNKI, PLIN</h2>
            ...
            <b-col cols="12" md="4" class="mb-3 mb-md-1">
              <h2 class="pay-online__subtitle-card text-center">Depositos o transferencias</h2>
              <div class="d-flex justify-content-around mt-4 flex-wrap">
                <div class="pay-online__image-pay mb-3">
                  <img src="@/assets/img-delete/visa-logo.jpg" alt="">
                </div>
                <div class="pay-online__image-pay">
                  <img src="@/assets/img/pagos/americaexpress-logo.png" alt="">
                </div>
              </div>
            </b-col>
          </b-row>
          <div class="mt-5">
            ...
            <div class="steps-list mt-4">
              <step-card title="Paso 1">
                <template v-slot>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. At, omnis sint? Voluptates perferendis voluptatibus ratione.
                  </p>
              ...
              <step-card title="Paso 2">
                <template v-slot>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit autem debitis modi eum rerum culpa perspiciatis! Quibusdam saepe nostrum deserunt rerum sint officia repellendus, quos id dolorum. Architecto quis laborum nemo ipsa minima voluptas nulla enim suscipit, asperiores ex perspiciatis assumenda inventore iusto, quas neque pariatur velit tempore temporibus porro iure reprehenderit eum. Fugit autem quis quod non molestias quibusdam!
                  </p>
                </template>
              </step-card>
              <step-card title="Paso 3">
                <template v-slot>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni aperiam id autem, sit laudantium nostrum voluptas quam temporibus, quod corrupti, cum quas ea accusantium iure quis perspiciatis sed quo officia.
                  </p>
                </template>
              </step-card>
            </div>
          ...
          <div class="text-center mt-4">
            <b-button variant="primary"><i class="fa-brands fa-whatsapp mr-2"></i>Enviar comprobante</b-button>
          </div>
        </b-card>
      </b-col>
    </b-row>
...
export default class PayOnline extends Vue {
