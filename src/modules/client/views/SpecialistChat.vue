<template>
  <div>
    <b-row class="mx-0" id="chat-box__container">
      <b-col cols="12" md="9" id="chat__container" class="bg-danger px-0">
        <div id="chat" class="border border-top-0">
          <div id="header-chat" class="d-flex align-items-center">
              ...
              <span class="header-char__name">Infraestructura Tecnologica profesional</span>
          </div>
          <div id="messages">
              <div class="message message-friend d-flex justify-content-start">
                  <div class="message__friend-image mr-2">
                    <img src="@/assets/img-delete/profile2.jpg" alt="" class="foto">
                  </div>
              ...
              <div
                ...
                :class="message.typeUser == 0? 'message-friend d-flex justify-content-start' : 'message-autor justify-content-end'"
              >
                  <div class="message__friend-image mr-2" v-if="message.typeUser == 0">
                    <img src="@/assets/img-delete/profile2.jpg" alt="" class="foto">
                  </div>
                  ...
                  <div class="message__list">
                    ...
                    >
                      <div class="flecha-izquierda"  v-if="message.typeUser == 0"></div>
                        <div class="contents text-left"
                          :class="message.typeUser == 0? 'contents--friend' : 'contents--autor'"
                        >
                            {{message.contents}}
                        </div>
                        <div class="flecha-derecha" v-if="message.typeUser == 1"></div>
          ...
          <div id="message-box" class="d-flex  ">
            <form @submit.prevent="handleSendMessage" class="w-100">
              <input type="text" placeholder="Escribir mensaje..." v-model="inputMessage" required>
              <button
                type="submit"
      ...
      <b-col cols="12" md="3" id="job__container" class="p-3 mt-3 mt-md-0 mb-4 mb-md-0">
        <h1 class="job__title ">Detalle del trabajo</h1>
        <hr class="mt-0">
        <div class="job-detail_container">
          <p class="job-detail__content">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora sunt earum amet minus omnis. Itaque delectus autem accusantium neque, totam sed sequi quae obcaecati aspernatur alias doloremque</p>
        </div>
      </b-col>
    </b-row>
