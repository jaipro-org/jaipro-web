<template>
  <div id="payments__container" class="mb-2 pt-4">
    ...
    <b-row class="mx-0 pt-2">
        ...
        <b-card class="payments__card">
          ...
          <b-row class="mx-0 pt-2">
            <b-col cols="12" md="8" class="mt-3">
              <b-form-group label-cols="12" label-cols-lg="4" label="Nombre cliente">
                <b-form-input v-model="client.name"  disabled></b-form-input>
              </b-form-group>
              <b-form-group label-cols="12" label-cols-lg="4" label="Categoria de servicio">
                <b-form-input v-model="client.category" disabled></b-form-input>
              </b-form-group>
              <b-form-group label-cols="12" label-cols-lg="4" label="Especialidad de servicio">
                <b-form-input v-model="client.speciality" disabled></b-form-input>
              </b-form-group>
              <b-form-group label-cols="12" label-cols-lg="4" label="Lugar de servicio">
      ...
      <b-col cols="12" class="mb-3 mb-md-1 px-0">
        <b-card class="payments__card">
          <h1 class="payments__title2-card text-center">Puedes realizar tus pagos por medio de las plataformas digitales</h1>
          <b-row class="mx-0 justify-content-around mt-4">
            <b-col cols="12" md="4" class="mb-3 mb-md-1">
              <h2 class="payments__subtitle-card text-center">YAPE, TUNKI, PLIN</h2>
            ...
            <b-col cols="12" md="4" class="mb-3 mb-md-1">
              <h2 class="payments__subtitle-card text-center">Depositos o transferencias</h2>
              <div class="d-flex justify-content-around mt-4 flex-wrap">
      ...
      <b-col cols="12" class="mb-3 mb-md-1 px-0">
        <b-card class="payments__card">
          ...
          <div class="mt-3">
            <b-table bordered striped hover responsive  :items="items" :fields="fields">
          ...
          <b-form @submit.prevent="sendPay" validated>
            <b-row class="mx-0">
              <b-col cols="12" md="5">
                ...
                >
                  <b-form-select v-model="form.bank" :options="options"></b-form-select>
                </b-form-group>
                <b-form-group
                  id="group-number"
                  ...
                  required
                >
                  <b-form-input id="input-number" v-model="form.numberOperation" required ></b-form-input>
                </b-form-group>
              </b-col>
              <b-col cols="12" md="7">
                <div for="asd" class="mr-5">Comprobante de pago</div>
                <span class="info" :class="cantImages? 'info-success' : 'info-danger'">*Este campo es obligatorio</span>
                <div class="">
                  <UploadImages
      ...
      <b-col cols="12" class="d-flex mb-5 px-0 justify-content-center">
        ...
        <b-button size="lg" variant="primary" class="mx-3" @click="$refs['form-button'].click()">Pagar</b-button>
      </b-col>
    </b-row>
