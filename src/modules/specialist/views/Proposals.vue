    ...
    <div class="jobs__container mx-0 mt-0 row">
      <div class="col-12 col-lg-8 pt-5">
        <div class="mt-1">
          <b-card class="job__filters">
            <div class="row mx-0">
              <div class="col-12">
                <b-form-group label="Estado de propuesta" label-for="select-status">
                  <v-select
                    id="select-status"
                    multiple
          ...
          <div class="jobs__list px-3">
            ...
            >
              <span class="job__data d-block">
                <b>Solicitante:</b> {{ item.petitioner }}
              </span>
              <span class="job__data d-block">
                <b>Especialidad:</b> {{ item.category }}
              </span>
          ...
          <div class="col-12 px-0">
            <div v-if="!isWorkDetailActive" class="job-detail__no-data">
              <div>
                ...
                <h4 class="text-center">Seleccionar una propuesta para abrirla</h4>
              </div>
            </div>
      ...
      >
        ...
        <div class="jobs__list px-3 pt-1">
          ...
          >
            <span class="job__data d-block">
                <b>Solicitante:</b> {{ job.petitioner }}
            </span>
            <span class="job__data d-block">
                <b>Especialidad:</b> {{ job.category }}
            </span>
            <span class="job__data d-block mt-2"><b>Descripción:</b></span>
            <p class="job__data">
              {{ job.description }}
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const statusOptions = ref<DropDownItem[]>([
        { value: 0, label: "Todas" },
        { value: 1, label: "Pendiente de aceptación" },
