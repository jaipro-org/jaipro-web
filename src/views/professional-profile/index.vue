    ...
    <b-container>
          ...
          <b-col md="9">
            <div class="datos">
              ...
              <div class="d-flex align-items-center mb-3">
                <b-form-rating :value="4" :v-model="2" variant="warning"></b-form-rating>
                <p class="total-rating text-center"><span>(13 valoraciones)</span></p>
              </div>
              <div class="btn-page">
                <b-button class="mr-2" variant="primary">Directo a cotizar</b-button>
              </div>
              <b-button-group>
                <b-button class="active">bio</b-button>
                <b-button>precios</b-button>
                <b-button>opiniones</b-button>
                <b-button>galeria</b-button>
              </b-button-group>
            </div>
          </b-col>
        </b-row>
      ...
      <b-card>
        <div class="title-logo">
          ...
          <div>
            ...
            <h5>Años en el sector: 5 años</h5>
          </div>
        </div>
      ...
      <b-card>
        <div class="title-logo">
          ...
          <div>
            <h3>Construcción y Arquitectura</h3>
            <h5>Años en el sector: 10 años</h5>
          </div>
        </div>
				<h4 class="card-title">Especialidades</h4>
				<ul class="list-dots">
